...
It follows a SQL-first ELT approach, focusing on data modeling, data quality, and analytical transformations. All data represents a fictional GCP billing account, created exclusively for learning purposes.
...
📈 Sample Results Usage and cost per month image

Records exceeding the P90 usage threshold image
